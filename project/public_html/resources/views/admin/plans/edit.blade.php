        ...
        <form action="{{ route('admin.plans.edit', $plan->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="features[research_tools]" id="i-features-research-tools" class="custom-select{{ $errors->has('features.research_tools') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if((old('features.research_tools') !== null && old('features.research_tools') == $key) || ($plan->features->research_tools == $key && old('features.research_tools') == null)) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="features[developer_tools]" id="i-features-developer-tools" class="custom-select{{ $errors->has('features.developer_tools') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if((old('features.developer_tools') !== null && old('features.developer_tools') == $key) || ($plan->features->developer_tools == $key && old('features.developer_tools') == null)) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="features[content_tools]" id="i-features-content-tools" class="custom-select{{ $errors->has('features.content_tools') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if((old('features.content_tools') !== null && old('features.content_tools') == $key) || ($plan->features->content_tools == $key && old('features.content_tools') == null)) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
