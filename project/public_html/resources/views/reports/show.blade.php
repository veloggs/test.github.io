...
@if($report->user->cannot('whiteLabelReports', ['App\Models\User']))
    <div class="d-none d-print-block border-bottom pb-3 mb-3">
        <div class="row">
            <div class="col">
                <div class="row no-gutters">
                    <div class="col-auto d-flex align-items-center">
                        <img src="{{ url('/') }}/uploads/brand/{{ (config('settings.dark_mode') == 1 ? config('settings.logo_dark') : config('settings.logo')) }}" class="height-10 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                    </div>
                    <div class="col d-flex align-items-center">
                        <div class="">
                            <div class="font-weight-bold">{{ config('settings.title') }}</div>

                            <div><a href="{{ route('home') }}" rel="nofollow" target="_blank" class="text-decoration-none">{{ route('home') }}</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
@if($report->user->can('brandReports', ['App\Models\User', $report->user]))
    <div class="d-none d-print-block border-bottom pb-3 mb-3">
        <div class="row">
            <div class="col">
                <div class="row no-gutters">
