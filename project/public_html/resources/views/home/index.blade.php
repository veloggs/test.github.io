...
<div class="flex-fill">
    <div class="bg-base-0 position-relative pt-5 pt-sm-6 pb-5 pb-md-7 overflow-hidden">
        <div class="row d-none d-lg-flex position-absolute top-0 right-0 bottom-0 left-0">
            ...
            <div class="col-6">
                ...
                <img src="{{ (config('settings.dark_mode') == 1 ? asset('images/hero_dark.png') : asset('images/hero.png')) }}" class="position-absolute bottom-0 shadow-lg border-top-left-radius-2xl border-top-right-radius-2xl {{ (__('lang_dir') == 'rtl' ? 'right-12' : 'left-12') }}" data-theme-dark="{{ asset('images/hero_dark.png') }}" data-theme-light="{{ asset('images/hero.png') }}" data-theme-target="src" style="width: 103rem; height: 29.8125rem;" alt="{{ config('settings.title') }}">
            </div>
        </div>
    ...
    <div class="bg-base-0">
        <div class="container position-relative py-5 py-md-7 d-flex flex-column z-1">
            <h3 class="h2 mb-3 font-weight-bold text-center">{{ __('Tools') }}</h3>
            <div class="m-auto text-center">
                <p class="text-muted font-weight-normal font-size-lg mb-0">{{ __('Over :count web tools and utilities.', ['count' => floor(count(config('tools')) / 10) * 10]) }}</p>
            </div>

            <div class="row position-relative">
                <div class="position-absolute top-0 right-0 bottom-0 left-0 z-1 more-gradient"></div>
                @foreach(array_slice(config('tools'), 0, config('settings.tools_guest') ? 16 : 20) as $tool)
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mt-5 @if($loop->index > 5) d-none d-sm-flex @endif">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __($tool['title']) }}</div></div>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="bg-base-1">
            <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
                <div class="flex-grow-1">
                    <div style="color: #007bff; background:#007bff33;" class="badge badge-pill badge-success mb-3 px-3 py-2">{{ __('Join us') }}</div>
                    <div class="text-center">
